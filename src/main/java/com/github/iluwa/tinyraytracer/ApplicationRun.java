...
public class ApplicationRun {
    public static void main(String[] args) {
        ...
        Material ivory = new Material(new Color(0.4f, 0.4f, 0.3f), 50d, 1d,0.6f, 0.3f, 0.1f, 0f);
        Material redRubber = new Material(new Color(0.3f, 0.1f, 0.1f), 10d, 1d,0.9f, 0.2f, 0f, 0f);
        Material mirror = new Material(new Color(1f, 1f, 1f), 1425f, 1d,0f, 10f, 0.8f, 0f);
        Material glass = new Material(new Color(0.6f, 0.7f, 0.8f), 125f, 1.5f, 0f, 0.5f, 0.1f, 0.8f);
        List<Sphere> spheres = new ArrayList<>();
        spheres.add(new Sphere(new Point3D(-3, 0, -15), 2, ivory));
        spheres.add(new Sphere(new Point3D(-1, -1.5, -12), 2, glass));
